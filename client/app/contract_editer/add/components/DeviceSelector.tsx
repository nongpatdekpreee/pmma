...
const inputBase = 'w-full rounded-xl border border-slate-200 bg-slate-50/80 p-3 text-sm outline-none transition-all focus:border-blue-400 focus:ring-2 focus:ring-blue-100';
      ...
      <div>
        ...
        {!selectedSiteId ? (
          ...
          <div className={`relative z-50 space-y-3 ${showDeviceDropdown ? 'mb-72' : ''}`}>
            <div
              className={`min-h-[3rem] w-full rounded-xl border bg-white px-3 py-2.5 transition-all ${
