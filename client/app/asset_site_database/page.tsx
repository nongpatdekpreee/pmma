  ...
  return (
    <SidebarLayout>
      ...
      <main className="mx-auto w-full max-w-full space-y-6 px-4 md:px-6 lg:px-8 py-6 md:mt-0 mt-16">
        ...
        {/* ================= Table Card ================= */}
        <div className="rounded-2xl bg-white p-4 md:p-6 shadow-md overflow-hidden">
          {/* Header */}
          ...
          <div className="overflow-x-auto w-full">
            <table className="w-full text-sm table-fixed" style={{ minWidth: '800px' }}>
              <thead className="bg-gray-50 text-xs uppercase text-gray-400">
                <tr>
                  <th
                    className="cursor-pointer px-2 py-3 text-left hover:bg-gray-100 whitespace-nowrap"
                  ...
                  <th className="px-3 py-3 text-left" style={{ width: '200px', minWidth: '150px' }}>Device Name</th>
                  <th className="px-3 py-3 text-left whitespace-nowrap">Role</th>
                  <th
                    className="cursor-pointer px-3 py-3 text-left hover:bg-gray-100 whitespace-nowrap"
                  ...
                  <th className="px-3 py-3 text-left whitespace-nowrap hidden lg:table-cell">Location</th>
                  <th
                    className="cursor-pointer px-3 py-3 text-left hover:bg-gray-100 whitespace-nowrap"
                ...
                {loading ? (
                  ...
                  paginatedDevices.map((device) => {
                    ...
                    return (
                      ...
                      >
                        <td className="px-2 py-3 font-medium text-indigo-600 whitespace-nowrap" style={{ width: '80px' }}>
                          {device.deviceId}
                        </td>
                        <td className="px-3 py-3" style={{ width: '200px', minWidth: '150px' }}>
                        ...
                        <td className="px-3 py-3 text-gray-600 hidden lg:table-cell">
                          <span className="truncate block max-w-[200px]">{device.location}</span>
                        </td>
                        <td className="px-3 py-3 whitespace-nowrap">
                          {device.lastPM ? (
                        ...
                        <td className="px-3 py-3">
                          <button
                            ...
                            className="flex items-center gap-1 rounded-lg bg-indigo-50 px-2 py-1 text-xs text-indigo-600 hover:bg-indigo-100 transition-colors whitespace-nowrap"
                          >
