...
const fs = require('fs');
const { createContract, uploadContractFile, getContractsBySite, getAvailableDevices, getDevicesByContract, getVendorStatistics } = require('../controllers/contractController');
