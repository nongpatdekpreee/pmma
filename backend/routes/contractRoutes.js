...
const fs = require('fs');
const { createContract, uploadContractFile, getContractsBySite, getAvailableDevices, getDevicesByContract, getVendorStatistics, getContractHistory } = require('../controllers/contractController');
